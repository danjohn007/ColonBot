-- ==========================================
-- 1. EJECUTAR CADA SENTENCIA POR SEPARADO
-- Si una columna ya existe, ignorar ese error
-- ==========================================

-- chatbot_sessions: Agregar columnas
