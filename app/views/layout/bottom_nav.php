...
<?php $navPrefix = routePrefix(); ?>
<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 safe-area-bottom">
  <div class="flex items-center justify-around h-16">
    <a href="<?= url($navPrefix . 'mapa') ?>" class="flex flex-col items-center gap-1 text-xs text-gray-500 hover:text-orange-700 transition px-3">
    ...
    <a href="<?= url($navPrefix . 'turista') ?>" class="flex flex-col items-center gap-1 text-xs text-gray-500 hover:text-orange-700 transition px-3">
      <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
      </svg>
      Visitante
    </a>
    <a href="<?= url($navPrefix . 'admin/notificaciones') ?>" class="flex flex-col items-center gap-1 text-xs text-gray-500 hover:text-orange-700 transition px-3">
      <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <?php endif; ?>
    <?php endif; ?>
    <a href="<?= url('login') ?>" class="flex flex-col items-center gap-1 text-xs text-gray-500 hover:text-orange-700 transition px-3">
      <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
      </svg>
