  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      ...
      <div class="flex items-center gap-2">
        <!-- CTA Facebook Turismo -->
        <a href="https://www.facebook.com/share/1LUHTDWc5t/" target="_blank" rel="noopener noreferrer"
           class="flex items-center gap-1.5 bg-blue-600 text-white px-2.5 py-1.5 rounded-lg text-xs font-medium hover:bg-blue-700 transition whitespace-nowrap">
