    ...
    <div class="flex items-center justify-between h-16">
      ...
      <div class="flex items-center gap-2">
        <a href="https://www.facebook.com/share/1LUHTDWc5t/" target="_blank" rel="noopener noreferrer"
           class="flex items-center gap-1.5 bg-blue-600 text-white px-2.5 py-1.5 rounded-lg text-xs font-medium hover:bg-purple-700 transition whitespace-nowrap">
        ...
        <?php else: ?>
          <a href="<?= e($loginUrl) ?>" class="inline-flex items-center gap-2 rounded-full bg-purple-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition">
