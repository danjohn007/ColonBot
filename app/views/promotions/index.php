  ...
  <div id="promotions-list" class="space-y-4">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 relative">
      <div class="delete-checkbox hidden absolute top-4 left-4 z-10">
        <input type="checkbox" value="<?= $p['id'] ?>" class="promo-delete-check w-5 h-5 accent-red-600 cursor-pointer">
      </div>
  ...
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 relative">
    ...
    <form onsubmit="savePromotion(event)" enctype="multipart/form-data" class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <!-- URL is auto-generated, no longer requested from user -->
        <input type="hidden" id="promo-url" value="">
      </div>
...
function savePromotion(e) {
  ...
  // URL is auto-generated by the server
  fd.append('public_url', '');
