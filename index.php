...
$router->post('admin/eventos/{id}/enviar',   'EventController', 'send');
$router->get('admin/eventos/{id}/historial', 'EventController', 'sendHistory');
...
$router->post('landing/admin/eventos/{id}/enviar',   'EventController', 'send');
$router->get('landing/admin/eventos/{id}/historial', 'EventController', 'sendHistory');
